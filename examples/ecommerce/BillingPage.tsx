...
import { Button } from "@/components/edithspace-ui/Button";
import { Input } from "@/components/edithspace-ui/Input";
import { Toggle } from "@/components/edithspace-ui/Toggle";
      ...
      <section className="w-full h-full flex -space-x-1 flex-wrap max-[800px]:hidden">
        <div className="w-1/2 h-full bg-gradient-to-t from-black to-green-950 p-8 flex flex-col gap-6 justify-between">
          <div className="flex flex-col gap-6">
            <div>
              <small>Subscribe to edithspace/ui</small>
          ...
          <div>
            <p className="text-sm opacity-80">
              @edithspace {year}, All rights reserved.
            </p>
          </div>
        </div>
...
const checkoutpage = () => {
  return (
    <>
      <DocsSEO
        title="Billing page - edithspace/ui"
