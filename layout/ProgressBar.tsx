...
import { ProgressBar } from "@/components/edithspace-ui/ProgressBar";
...
const progressbar = () => {
  return (
    <>
      <DocsSEO
        title="Progress Bar - edithspace/ui"
      ...
      <DocsLayout>
        <main>
          ...
          <CodeBlock
            ...
            lang="tsx"
            filename="tsx"
            code={`import { ProgressBar } from "@/components/edithspace-ui/ProgressBar";
